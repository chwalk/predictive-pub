...
def get_user_assigned_credential(client_id):
    az_credential = DefaultAzureCredential(managed_identity_client_id=client_id)
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    user_managed_identity_client_id = '<client id of user-assigned identity (not function app)>'

    credential = get_user_assigned_credential(user_managed_identity_client_id)
